        ...
        <fieldset class="adminform">
            ...
            <table class="admintable">
                ...
                <tr>
                    ...
                    <td>
                        <span style="float:left;"><?php echo JText::_("Use: "); ?></span><input type=checkbox name=c_crontab value='1'><input type="text" name="crontab" id="crontab" value="<?php echo JText::_($this->cron->mhdmd); ?>" />
                    </td>
                </tr>
