...
<fieldset class="batch">
	<legend><?php echo JText::_('COM_REF_BATCH_OPTIONS');?></legend>
	<p><?php echo JText::_('COM_REF_BATCH_TIP'); ?></p>
	...
	<?php if ($published >= 0) : ?>
		<?php echo JHtml::_('batch.item', 'com_ref');?>
	<?php endif; ?>

	<button type="submit" onclick="Joomla.submitbutton('webometric.batch');">
