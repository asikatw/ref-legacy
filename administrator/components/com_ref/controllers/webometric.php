...
/**
 * Webometric controller class.
 */
class RefControllerWebometric extends JControllerForm
{
	 ...
	 * @since	1.6
	 */
	public function getModel($name = 'Webometric', $prefix = 'RefModel', $config = array('ignore_request' => true))
	{
	...
	public function batch($model = null)
	{
		...
		// Preset the redirect
		$this->setRedirect(JRoute::_('index.php?option=com_ref&view=webometrics' . $this->getRedirectToListAppend(), false));
