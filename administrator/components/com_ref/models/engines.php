 ...
 */
class RefModelEngines extends JModelList
{
	...
	public function getFilter()
	{
		...
		// load forms
		$form['search'] = JForm::getInstance('com_ref.engines.search', 'engines_search', array( 'control' => 'search' ,'load_data'=>'true'));
		$form['filter'] = JForm::getInstance('com_ref.engines.filter', 'engines_filter', array( 'control' => 'filter' ,'load_data'=>'true'));
