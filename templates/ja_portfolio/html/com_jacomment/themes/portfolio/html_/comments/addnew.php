			...
			<div class="jac-expand-form clearfix">				
				...
				<div class="form-userdata clearfix">
					...
					<span class="jac-form-guest">
						...
						<input id="guestName" value="<?php //echo JText::_("TEXT_NAME");?>" name="name" type="text" class="field text inputbox <?php //jac-inner-text?>" size="18" tabindex="2" title="<?php echo JText::_("Displayed next to your comments.");?>"/>
					...
					<span class="jac-form-guest">
						...
						<input id="guestEmail" value="<?php //echo JText::_("TEXT_EMAIL");?>" name="email" type="text" class="field text inputbox <?php //jac-inner-text?>" value="" size="18" tabindex="3" title="<?php echo JText::_("Not displayed publicly.");?>"/>
					...
					<span class="jac-form-guest">
						...
						<input id="guestWebsite" name="website" type="text" class="field text inputbox jac-inner-text" value="<?php echo JText::_("TEXT_WEBSITE");?>" size="18" tabindex="4" title="<?php echo JText::_("(Optional) "); echo JText::_("If you have a website, link to it here.");?>" />
