...
?>
	<?php if($display_comment_link){?>	
		<div class="jac-add-button"><a class="jac-links" href="<?php echo $links; ?>" title="<?php echo JText::_('ADD COMMENT'); ?>"><?php echo JText::_('ADD COMMENT'); ?></a>
...
<?php if($typeDisplay == "onlyButton" && $display_comment_link):?>	
	<div class="jac-add-button"><a class="jac_links jac-links<?php echo $id;?>" href=<?php echo $links; ?> title="<?php echo JText::_('ADD COMMENT'); ?>"><?php echo JText::_('ADD COMMENT'); ?></a>
<?php endif; ?>
...
?>	
	<span class="jac-links<?php echo $id;?>">(<?php echo $totalAll ?>)</span></div>
<?php endif;?>
<?php }?>