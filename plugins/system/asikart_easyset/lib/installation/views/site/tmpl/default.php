					...
					<div class="m">
						<fieldset>
							<table class="content2 sample-data">
								...
								<tr>
									<td colspan="2">
										<span id="theDefault"><input class="button"  disabled="true" type="button" name="instDefault" value="<?php echo JText::_('INSTL_SITE_INSTALL_SAMPLE_LABEL'); ?>" onclick="Install.sampleData(this, <?php echo $this->form->getField('sample_file')->id;?>);"/></span>
									</td>
								</tr>
								<tr>
									<td>&#160;</td>
